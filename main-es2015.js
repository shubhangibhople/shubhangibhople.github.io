...
const routes = [
    ...
    {
        path: "update-employee", component: _update_employee_update_employee_component__WEBPACK_IMPORTED_MODULE_9__["UpdateEmployeeComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
...
let HomeComponent = class HomeComponent {
    ...
    onChangeStatus() {
        if (this.onRadioCheck()) {
            this.service.getEmpStatus(this.empobj.id)
                .subscribe((response) => {
                // console.log(response);
...
let HttpService = class HttpService {
    ...
    getEmpStatus(id) {
        return (this.http.get(`${this.baseUrl}getStatus/${id}`, { responseType: "text" }));
    }
};
...
module.exports = __webpack_require__(/*! H:\ForntEnd\Angular\ProjectWork\src\main.ts */"./src/main.ts");
